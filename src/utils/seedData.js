  ...
  packages: [
    {
      ...
      priceAdult: 45000,
      priceChild: 25000,
      destinations: ['Maasai Mara', 'Narok'],
    ...
    },
    {
      ...
      description: 'Stunning views of Mt. Kilimanjaro and large elephant herds.',
      duration: 2,
      priceAdult: 32000,
      priceChild: 18000,
      destinations: ['Amboseli'],
      included: ['Transport', 'Park Fees', 'Lunch'],
      image: 'https://images.unsplash.com/photo-1547471080-7cc2001d0138?auto=format&fit=crop&q=80&w=800'
    },
    {
      id: 'p3',
      name: 'Coast Chill & Diani Beach',
      description: 'Relax at the best beach in Africa.',
      duration: 5,
      priceAdult: 65000,
      priceChild: 35000,
      destinations: ['Diani', 'Mombasa'],
      included: ['Flight', 'Transfer', 'Half-board'],
