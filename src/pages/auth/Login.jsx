  ...
  <div className="min-h-screen flex items-center justify-center bg-safari-bg dark:bg-dark-bg p-4 relative overflow-hidden">
    ...
    <div className="w-full max-w-md animate-fade-in relative z-10">
      <div className="text-center mb-8">
        <div className="inline-flex items-center justify-center w-16 h-16 bg-safari-primary dark:bg-safari-gold rounded-2xl mb-4 shadow-lg">
          <span className="text-2xl font-playfair font-bold text-white dark:text-safari-primary">TP</span>
        </div>
        <h1 className="text-3xl font-playfair font-bold text-safari-primary dark:text-dark-text">ToursPro</h1>
