...
export const Sidebar = ({ role }) => {
  ...
  const resMenu = [
    ...
    { to: '/reservations/live-tracking', icon: Map, label: 'Live Tracking' },
    { to: '/reservations/sos-alerts', icon: ShieldAlert, label: 'SOS Alerts' },
    { to: '/reservations/messages', icon: MessageSquare, label: 'Fleet Messages' },
